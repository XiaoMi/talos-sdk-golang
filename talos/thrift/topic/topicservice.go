...
func NewTopicServiceProcessor(handler TopicService) *TopicServiceProcessor {
	self43 := &TopicServiceProcessor{common.NewTalosBaseServiceProcessor(handler)}
	self43.AddToProcessorMap("createTopic", &topicServiceProcessorCreateTopic{handler: handler})
	self43.AddToProcessorMap("deleteTopic", &topicServiceProcessorDeleteTopic{handler: handler})
	self43.AddToProcessorMap("changeTopicAttribute", &topicServiceProcessorChangeTopicAttribute{handler: handler})
	self43.AddToProcessorMap("describeTopic", &topicServiceProcessorDescribeTopic{handler: handler})
	self43.AddToProcessorMap("listTopicsInfo", &topicServiceProcessorListTopicsInfo{handler: handler})
	self43.AddToProcessorMap("listTopics", &topicServiceProcessorListTopics{handler: handler})
	self43.AddToProcessorMap("getBindTopics", &topicServiceProcessorGetBindTopics{handler: handler})
	self43.AddToProcessorMap("setTopicQuota", &topicServiceProcessorSetTopicQuota{handler: handler})
	self43.AddToProcessorMap("queryTopicQuota", &topicServiceProcessorQueryTopicQuota{handler: handler})
	self43.AddToProcessorMap("deleteTopicQuota", &topicServiceProcessorDeleteTopicQuota{handler: handler})
	self43.AddToProcessorMap("setPermission", &topicServiceProcessorSetPermission{handler: handler})
	self43.AddToProcessorMap("revokePermission", &topicServiceProcessorRevokePermission{handler: handler})
	self43.AddToProcessorMap("listPermission", &topicServiceProcessorListPermission{handler: handler})
	self43.AddToProcessorMap("getPermission", &topicServiceProcessorGetPermission{handler: handler})
	self43.AddToProcessorMap("addSubResourceName", &topicServiceProcessorAddSubResourceName{handler: handler})
	return self43
}
