...
func NewDefaultTalosConsumer(consumerGroupName string, consumerConfig *TalosConsumerConfig,
	...
	c := &TalosConsumer{
		...
		checkPartTaskChan:       make(chan utils.StopSign, 1),
		checkWorkerTaskChan:     make(chan utils.StopSign, 1),
		renewTaskChan:           make(chan utils.StopSign, 1),
		monitorTaskChan:         make(chan utils.StopSign, 1),
